  ...
  if (!isSupabaseConfigured) {
    return (
      <div className="h-screen w-screen flex flex-col items-center justify-center bg-background p-4">
        <div className="bg-surface p-8 rounded-3xl shadow-2xl max-w-lg w-full text-center border border-red-500/20">
          ...
          <div className="text-left bg-surfaceHighlight p-4 rounded-xl mb-6 space-y-3 border border-border">
            <div>
              <p className="text-xs font-bold text-textMuted uppercase mb-1">1. Create Project</p>
              <a href="https://supabase.com" target="_blank" rel="noreferrer" className="text-primary hover:underline">
                supabase.com
              </a>
            </div>
            <div>
              <p className="text-xs font-bold text-textMuted uppercase mb-1">2. Run Database Schema</p>
              <p className="text-sm text-text">Run the SQL from <code className="bg-black/30 px-1 rounded">supabase_schema.sql</code></p>
            </div>
            <div>
               <p className="text-xs font-bold text-textMuted uppercase mb-1">3. Set Environment Variables</p>
          ...
          <button 
            ...
            className="bg-primary hover:bg-primaryHover text-white px-6 py-2 rounded-xl font-bold transition-colors w-full"
          >
            Refresh App
          </button>
        </div>
