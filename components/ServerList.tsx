...
import { Plus, Gamepad2, Home } from 'lucide-react';
  ...
  return (
    <div className="flex items-center gap-3 h-full">
      ...
      <div className="relative group">
        <button
          className="w-12 h-12 rounded-2xl bg-surfaceHighlight hover:bg-primary text-textMuted hover:text-white transition-all duration-300 flex items-center justify-center shadow-lg hover:shadow-primary/25 hover:-translate-y-1"
        >
           <Home size={24} />
        </button>
        {/* Tooltip */}
